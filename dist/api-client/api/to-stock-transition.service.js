...
let ToStockTransitionService = (() => {
    ...
    var ToStockTransitionService = _classThis = class extends _classSuper {
    ...
    __setFunctionName(_classThis, "ToStockTransitionService");
    (() => {
        var _a;
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ToStockTransitionService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ToStockTransitionService = _classThis;
})();
export { ToStockTransitionService };
//# sourceMappingURL=to-stock-transition.service.js.map